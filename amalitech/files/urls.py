...
from .views import FileListView, FileDetailView, FileDownloaderView,send_file_email, UploadFileView
...
urlpatterns = [
    ...
    path('download/<int:pk>/', FileDownloaderView.as_view(), name='download'),
